...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ isOpen, setIsOpen }) => {
    ...
    const menuItems = [
        ...
        {
            id: 'drivers',
            path: `/${lang}/admin/drivers`,
            icon: Truck,
            label: 'Drivers'
        },
        {
            id: 'requests',
            path: `/${lang}/admin/requests`,
            icon: ClipboardList,
            label: 'Tow Requests'
        },
    ];
            ...
            >
                <div className="flex flex-col h-full">
                    ...
                    <div className="h-20 flex items-center justify-between px-6 border-b border-gray-50">
                        <Link to={`/${lang}/admin/dashboard`} className="flex items-center space-x-2 group">
                            <div className="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center font-black text-white italic shadow-lg shadow-indigo-200 group-hover:scale-110 transition-transform">A</div>
                            {isOpen && <span className="text-2xl font-black tracking-tighter text-gray-900 uppercase">Admin</span>}
                        </Link>
                        {isOpen && (
                            <button
                                onClick={() => setIsOpen(false)}
                    ...
                    <div className="p-4 border-t border-gray-50 space-y-2">
                        ...
                        <button
                            ...
                            className="hidden lg:flex items-center justify-center w-full p-2 text-gray-300 hover:text-indigo-600 hover:bg-gray-50 rounded-xl transition-all"
                        >
